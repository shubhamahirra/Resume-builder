      ...
      <div className="resume-preview-grid-container">
        ...
        <div className="resume-preview-grid-item">
          <div className="resume-save-container">
            ...
            <Typography sx={{fontSize:{xs:12, lg:20},grid:{xs:10,lg:"none"},position:"relative", right:{xs:10}}} variant="h3" >Create File Name</Typography>
            <TextField
              value={resumeName}
              onChange={(e) => setResumeName(e.target.value)}
              className="resume-name-field"
              sx={{ width: "70%", position:"relative" ,right:{xs:10} }}
              id="outlined-basic"
              variant="outlined"
            ...
            <div className="resume-back-next-container">
              <Button
                ...
                sx={{ marginRight: "20px",position:"relative", top:{lg:0,sm:0,xs:0}, right:{xs:10,sm:10} }}
              ...
              {loading ? (
                ...
                <Button
                  ...
                  variant="contained" sx={{ top:{lg:0,sm:50,xs:50,md:0}, right:{xs:130,sm:130,md:0, lg:0}}}>
                  Save
                </Button>
              )}
            </div>
